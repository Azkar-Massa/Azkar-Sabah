// نصوص وعدادات أذكار الصباح الـ 23 بالترتيب
const sabahAzkar = [
...
function updateZikr() {
    ...
    // هيدور على الأصوات جوه فولدر audio باسم Zikri1.mp3, Zikri2.mp3... إلخ
    const audioUrl = "audio/Zikri" + (currentIndex + 1) + ".mp3";
    currentAudio = new Audio(audioUrl);
}

playAudioBtn.addEventListener("click", () => {
    if (currentAudio) {
        currentAudio.play().catch(err => console.log("المتصفح يطلب ضغطة على الشاشة أولاً"));
    }
});
...
// تشغيل أول ذكر تلقائياً عند فتح الموقع
updateZikr();